...
class AdmsViewUsers
{
    ...
    public function viewUser(int $id): void
    {
        ...
        $viewUser->fullRead("SELECT usr.id, usr.name AS name_usr, usr.email, usr.tel_1, usr.tel_2, 
                            usr.user, usr.image, usr.created, usr.modified, sit.name AS name_sit, col.color, lev.id AS id_lev, lev.name AS name_lev, 
