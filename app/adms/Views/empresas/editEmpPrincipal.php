            ...
            <form method="POST" action="" id="form-edit-emp-principal" class="form-adm">
                ...
                <div class="row-input">
                    ...
                    <div class="column">
                        <?php
                        $contrato = "";
                        if (isset($valorForm['contrato'])) {
                            $contrato = $valorForm['contrato'];
                        }
                        ?>
                        ...
                        <select name="contrato" id="contrato" class="input-adm" required>
                            ...
                            <?php
                            foreach ($this->data['select']['num_contr'] as $num_contr) {
                                extract($num_contr);
                                if ((isset($valorForm['contrato'])) and ($valorForm['contrato'] == $id_cont)) {
