        ...
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if ($this->data['button']['view_profile']) {
                    echo "<a href='" . URLADM . "list-contr/index' class='btn-primary'>Listar</a> ";
                }
                ?>
            </div>
        </div>
            ...
            <form method="POST" action="" id="form-edit-prof-logo" class="form-adm" enctype="multipart/form-data">
                ...
                <div class="row-input">
                    ...
                    <div class="column">
                        <?php
                        $logo_clie = "";
                        if (isset($valorForm['logo_clie'])) {
                            $logo_clie = $valorForm['logo_clie'];
                        }
                        ?>
                    ...
                    <div class="column">
                        <?php
                        if ((!empty($valorForm['logo_clie'])) and (file_exists("app/adms/assets/image/logo/contratos/" . $_SESSION['id_contrato'] . "/" . $valorForm['logo_clie']))) {
                            
                            $old_image = URLADM . "app/adms/assets/image/logo/contratos/" . $_SESSION['id_contrato'] . "/" . $valorForm['logo_clie'];
                        } else {
                            $old_image = URLADM . "app/adms/assets/image/logo/contratos/icon_user.png";
                        }
                        ?>
                        <span id="preview-img">
