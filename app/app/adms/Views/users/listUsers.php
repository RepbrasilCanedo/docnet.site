        ...
        <table class="table table-hover table-list">
            <thead class="list-head">
                <tr>
                    ...
                    <th class="list-head-content table-md-none">Empresa</th>
            ...
            <tbody class="list-body">
                ...
                ?>
                    <tr>
                        <td class="list-body-content"><?php echo $id_usr; ?></td>
                        <td class="list-body-content"><?php echo $name_usr; ?></td>
                        <td class="list-body-content table-sm-none"><?php echo $email_usr; ?></td>
                        <td class="list-body-content"><?php echo $tel1_usr; ?></td>
