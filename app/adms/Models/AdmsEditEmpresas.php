...
class AdmsEditEmpresas
{
    ...
    public function viewEmpresas(int $id): void
    {
        ...
        $viewEmpresas->fullRead("SELECT emp.id, emp.razao_social, emp.nome_fantasia, emp.cnpjcpf, emp.cep, emp.logradouro, emp.bairro, emp.cidade, emp.uf, emp.situacao , contrato, emp.created, emp.modified
    ...
    private function edit(): void
    {
        ...
        if ($upEmpresas->getResult()) {
            ...
            $_SESSION['msg'] = "<p class='alert-danger'>Erro: Empresa não editada com sucesso!</p>";
            $this->result = false;
        }
    }
    ...
    public function listSelect(): array
    {
        ...
        $this->listRegistryAdd = ['sit_empresas' => $registry['sit_empresas']];
