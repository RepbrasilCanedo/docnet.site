            ...
            <div class="top-list-right">
                ...
                if (!empty($this->data['viewcontato'])) {
                    if ($this->data['button']['edit_contato']) {
                        echo "<a href='" . URLADM . "edit-contato/index/" . $this->data['viewContato'][0]['id'] . "' class='btn-warning'>Editar</a> ";
                    }
                    if ($this->data['button']['delete_contato']) {
                        echo "<a href='" . URLADM . "delete-contato/index/" . $this->data['viewContato'][0]['id'] . "' onclick='return confirm(\"Tem certeza que deseja excluir este registro?\")' class='btn-danger'>Apagar</a> ";
                    }
                }
                ?>
            </div>
