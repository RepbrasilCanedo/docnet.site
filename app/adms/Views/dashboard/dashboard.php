                        ...
                        <div class="carousel-item active">
                            <div class="carousel-caption d-none d-md-block">                                
                                <a href="https://www.instagram.com/repbrasilcomunicacaovisual" target="_blank">
                                    <i class="fab fa-instagram btn-lg btn-danger mt-3" data-toggle="tooltip" data-placement="top" title="Conheça nossa linha de produtos gráfico através de nosso Instagram"></i> Rep Brasil Comunicação Visual
                                </a>
                            </div>
