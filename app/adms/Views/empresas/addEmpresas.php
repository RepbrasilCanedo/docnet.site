            ...
            <form method="POST" action="" id="form-add-empresas" class="form-adm">
                ...
                <div class="row-input">
                    ...
                    <div class="column">
                        ...
                        <input type="text" name="cnpjcpf" id="cnpjcpf" class="input-adm" placeholder="Número do Cnpj" value="<?php echo $cnpj; ?>" required>
                    </div>
                </div>
                    ...
                    <?php if (($_SESSION['adms_access_level_id'] == 1) or ($_SESSION['adms_access_level_id'] == 2)) { ?>
                        <div class="column">
                            ...
                            <select name="empresa" id="empresa" class="input-adm" required>
                                ...
                                <?php
                                foreach ($this->data['select']['empresa'] as $clieEmpresas) {
                                    extract($clieEmpresas);
                                    if (isset($valorForm['empresa']) and $valorForm['empresa'] == $id) {
