...
class AdmsViewCham
{
    ...
    public function viewCham(int $id): void
    {
        ...
        $viewCham->fullRead("SELECT cham.id, clie.nome_fantasia as nome_fantasia_clie, prod.name as name_prod, prod.marca_id as marca_id_prod, prod.modelo_id as modelo_id_prod, cham.contato, cham.tel_contato, usr.name AS name_usr, usr.tel_1 AS tel_1_usr,
