...
class AdmsEditUsers
{
    ...
    public function viewUser(int $id): void
    {
        ...
        $viewUser->fullRead("SELECT usr.id, usr.name, usr.email, usr.tel_1, usr.tel_2, usr.empresa_id, usr.setor_id, usr.user, 
                            usr.adms_sits_user_id, usr.adms_access_level_id, usr.contr_id FROM adms_users AS usr
