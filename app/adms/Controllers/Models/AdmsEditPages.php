...
class AdmsEditPages
{
    ...
    public function viewPages(int $id): void
    {
        ...
        $viewPages->fullRead("SELECT pg.id, pg.controller, pg.metodo, pg.menu_controller, pg.menu_metodo, pg.name_page, pg.publish, pg.icon, pg.obs, pg.adms_sits_pgs_id, 
        pg.adms_types_pgs_id, pg.adms_groups_pgs_id, tpg.name name_tpg, sit.name name_sit, grpg.name name_grpg, tpg.type type_tpg
