...
class AdmsListItemMenu
{
    ...
    public function listItemMenu(int $page = null):void
    {
        ...
        if($this->resultBd){
            ...
            $_SESSION['msg'] = "<p style='color: #f00'>Erro: Nenhuma item de menu encontrado!</p>";
            $this->result = false;
        }
    }
     ...
     * @return void
     */
    public function listSearchItemMenu(int $page = null, string|array|null $search_name):void
    {
        $this->page = (int) $page ? $page : 1;
        ...
        if($this->resultBd){
            ...
            $_SESSION['msg'] = "<p style='color: #f00'>Erro: Nenhum item de menu encontrado!</p>";
            $this->result = false;
        }
    }
